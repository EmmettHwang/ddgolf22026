...
| 버전 | 날짜 | 내용 |
|------|------|------|
| 3.9.20260913.1910 | 2026-09-13 | 가상계좌 결제가 시작되지 않던 것 수정 — `vbankHolder` 누락(P007) + `vbankExpDate` 형식(P024, ISO8601) |
| 3.8.20260913.1640 | 2026-09-13 | 서버이용료 — 관리자 탭에 링크, `/server-billing.html` 결제 화면(카드+가상계좌), 기한 7일 이내면 안내 팝업 |
| 3.7.20260622.0830 | 2026-06-22 | 버전 체크 버튼 (최신버전/새버전 확인), 빌드별 자동 캐시 갱신 (version.json) |
| 3.6.20260622 | 2026-06-22 | 관리자 대시보드에 새로고침 버튼 추가 |
| 3.5.20260622 | 2026-06-22 | 전체 alert/confirm을 커스텀 중앙 모달 다이얼로그로 교체 (7개 파일, 100+개소) |
| 3.4.20260622 | 2026-06-22 | 공지/배너/유관기관/서식 목록에 일련번호·목록수·검색필터 추가, 경기일정 일련번호, nginx SW 캐시 방지 |
| 3.3.20260622 | 2026-06-22 | 경기일정 목록에 전체 수 표시 및 검색 필터 추가 |
| 3.2.20260618.0100 | 2026-06-18 | 회원관리 페이지네이션/검색/정렬, PWA 캐시 자동 갱신, 전체회원 삭제 기능, 회원수 제한 해제 |
